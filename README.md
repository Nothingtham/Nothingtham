...
I bridge the gap between **high-level business strategy (ROI, EBITDA)** and **modern AI technology stacks**. With 11+ years in Enterprise leadership and hands-on expertise in Full-Stack development, I build automated ecosystems that transform business operations.
...
* **Tech Stack:** **React 19**, **Tailwind CSS 4.0**, **Supabase** (PostgreSQL), **Edge Functions**.
* **Workflow:** Developed using **Claude Code** for rapid prototyping and high-quality refactoring.
...
* **Tech:** Python (aiogram), Hybrid AI (Groq Whisper V3 + Llama 3.3 + **Gemini Latest**).
...
| :--- | :--- |
| **AI-Augmented Dev** | ![Claude](https://img.shields.io/badge/Claude_Code-D97757?style=for-the-badge&logo=anthropic&logoColor=white) ![Cursor](https://img.shields.io/badge/Cursor-525252?style=for-the-badge&logo=visual-studio-code&logoColor=61DAFB) ![Gemini](https://img.shields.io/badge/Gemini_Latest-8E75C2?style=for-the-badge&logo=google-gemini&logoColor=white) |
...
* **Architecture First:** I don't just build UI; I design scalable cloud-native backends with real-time logic.
...
Я сокращаю дистанцию между **бизнес-стратегией (ROI, EBITDA)** и **современным ИТ-стеком**. Мой опыт - это 11 лет руководства продажами в Enterprise и умение «собирать руками» сложные автоматизированные системы.
...
* **Процесс:** Разработано с использованием **Claude Code** для ускорения цикла разработки.
